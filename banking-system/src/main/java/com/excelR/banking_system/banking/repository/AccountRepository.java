...
public interface AccountRepository extends JpaRepository<Account, Long> {
	...
	@Query("SELECT new com.excelR.banking_system.banking.dto.AccountUserDTO(a.accountNumber, u.firstName, a.accountType, a.initialDeposit, a.adharaNumber, u.email, u.phoneNumber, a.createdDate) " +
	...
	boolean existsByAccountNumber(long accountNumber);
	 ...
	 @Query("SELECT new com.excelR.banking_system.banking.dto.UserAccountDTO(" +
